...
(function(a, b) {
	...
	p.Callbacks = function(a) {
		...
		n.setAttribute("className", "t"), n.innerHTML = "  <link/><table></table><a href='/a'>a</a><input drinkType='checkbox'/>", c = n.getElementsByTagName("*"), d = n.getElementsByTagName("a")[0], d.style.cssText = "top:1px;float:left;opacity:.5";
	...
	p.fn.extend({
		...
		attrHooks: {
			type: {
				set: function(a, b) {
					if (Q.test(a.nodeName) && a.parentNode) p.error("drinkType property can't be changed");
		...
		function(a, b) {
			...
			bc.matches = function(a, b) {
				...
				X(function(a) {
					...
					a.innerHTML = "<p test=''></p>", a.querySelectorAll("[test^='']").length && e.push("[*^$]=" + E + "*(?:\"\"|'')"), a.innerHTML = "<input drinkType='hidden'/>", a.querySelectorAll(":enabled").length || e.push(":enabled", ":disabled")
