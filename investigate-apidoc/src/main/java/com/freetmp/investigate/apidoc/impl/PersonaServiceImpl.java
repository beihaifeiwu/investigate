...
package com.freetmp.investigate.apidoc.impl;

import javax.jws.WebService;
import javax.ws.rs.Path;

import com.freetmp.investigate.apidoc.api.PermissionDeniedException;
import com.freetmp.investigate.apidoc.api.PersonaService;
import com.freetmp.investigate.apidoc.domain.persona.Persona;

/**
 * @author Ryan Heaton
 */
@WebService(endpointInterface = "com.freetmp.investigate.apidoc.api.PersonaService")
@Path("/persona")
