...
public class CRSLab {
  ...
  class ExportShapefileAction extends SafeAction {
    ...
    @Override public void action(ActionEvent e) throws Throwable {
      exportToShapefile2();
    }
    ...
    private void exportToShapefile2() throws IOException {
      JFileDataStoreChooser chooser = new JFileDataStoreChooser("shp");
      chooser.setDialogTitle("Save reprojected shapefile");
      chooser.setSaveFile(sourceFile);
      int returnVal = chooser.showSaveDialog(null);
      ...
      featureStore = (SimpleFeatureStore) newDataStore.getFeatureSource(featureCollection.getSchema().getTypeName());
