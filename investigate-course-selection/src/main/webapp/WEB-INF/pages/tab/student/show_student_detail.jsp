        ...
        <td bgcolor="#f3ffe3">
        	<div align="left" style="margin-left: 50px; margin: 50px;" class="STYLE4">
				<table width="100%" bgcolor="#c0de98" border="0" cellspacing="2" cellpadding="5px">
					<tr>
						<td bgcolor="#FFFFFF" align="center"><label>学生学号</label></td>
						<td bgcolor="#FFFFFF" align="center"><s:property value="student.account" /></td>
					</tr>
					<tr>
						<td bgcolor="#FFFFFF" align="center"><label>姓名</label></td>
						<td bgcolor="#FFFFFF" align="center"><s:property value="student.profile.name" /></td>
					</tr>
					<tr>
						...
						<s:if test="student.profile.Photo != null">
							<s:url var="url" action="image" namespace="/">
								<s:param name="userID"><s:property value="student.ID"/></s:param>
							</s:url>
					...
					<tr>
						<td bgcolor="#FFFFFF" align="center"><label>学生班级</label></td>
						<td bgcolor="#FFFFFF" align="center"><s:property value="student.clazz" /></td>
					</tr>
					<tr>
						<td bgcolor="#FFFFFF" align="center"><label>所属院系</label></td>
						<td bgcolor="#FFFFFF" align="center"><s:property value="student.profile.department" /></td>
					</tr>
					<tr>
						<td bgcolor="#FFFFFF" align="center"><label>手机号码</label></td>
						<td bgcolor="#FFFFFF" align="center"><s:property value="student.profile.phoneNumber" /></td>
					</tr>
					<tr>
						<td bgcolor="#FFFFFF" align="center"><label>电子邮件</label></td>
						<td bgcolor="#FFFFFF" align="center"><s:property value="student.profile.email" /></td>
					</tr>
					<tr>
						<td bgcolor="#FFFFFF" align="center"><label>籍贯</label></td>
						<td bgcolor="#FFFFFF" align="center"><s:property value="student.profile.birthPalce" /></td>
					</tr>
					<tr>
						<td bgcolor="#FFFFFF" align="center"><label>出生日期</label></td>
						<td bgcolor="#FFFFFF" align="center"><s:date name="student.profile.birthTime" /></td>
					</tr>
				</table>
	        </div>
        </td>
