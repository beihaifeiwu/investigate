...
Scrollbar-3Dlight-Color:8cc106;
Scrollbar-Darkshadow-Color:8cc106;
...
function mOvr(v) {
   ...
   if(sObj.innerHTML!='') {
      ...
      if(cld[d].solarTerms == '' && cld[d].solarFestival == '' && cld[d].lunarFestival == '')
         ...
         festival = '<TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 BGCOLOR="#61f961"><TR><TD>'+
         '<FONT COLOR="#000000" STYLE="font-size:9pt;">'+cld[d].solarTerms + ' ' + cld[d].solarFestival + ' ' + cld[d].lunarFestival+'</FONT></TD>'+
         '</TR></TABLE>';

      s= '<TABLE WIDTH="130" BORDER=0 CELLPADDING="2" CELLSPACING=0 BGCOLOR="#266600"><TR><TD>' +
...
<TABLE >
  ...
  <TR>
    ...
    <TD align=middle>
      ...
      style="FONT-SIZE: 100pt; COLOR: #5ca14c; FONT-FAMILY: 'Arial Black'">&nbsp;0000<BR>&nbsp;JUN</FONT> 
      </DIV>
      <TABLE border=0>
        <TBODY>
        <TR>
