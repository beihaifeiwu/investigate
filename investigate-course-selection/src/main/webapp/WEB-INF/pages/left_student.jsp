                ...
                <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="84%" height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="menuitem">
                          	<a href="<s:url action="showDetail" namespace="/student"/>" target="tabFrame"><span class="STYLE3">个人信息</span></a>
                          </td>
                        </tr>
                    </table></td>
                  </tr>
                  <tr>
                    ...
                    <td height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="menuitem">
                          	<a href="<s:url action="prepareToModifyStudent" namespace="/student"/>" target="tabFrame"><span class="STYLE3">修改信息</span></a>	
                          </td>
                        </tr>
                    </table></td>
                  </tr>
                    ...
                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="84%" height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td class="menuitem">
                                	<a href="<s:url action="courseSelect" namespace="/student"/>" target="tabFrame"><span class="STYLE3">网上选课</span></a>
                                </td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          ...
                          <td height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td class="menuitem">
                                	<a href="<s:url action="studentCourseTable" namespace="/student"/>" target="tabFrame"><span class="STYLE3">查看课表</span></a>
                                </td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          ...
                          <td height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td class="menuitem">
                                	<a href="<s:url action="scanSelectedCourse" namespace="/student"/>" target="tabFrame"><span class="STYLE3">查看已选课程</span></a>
                                </td>
                              </tr>
                          </table></td>
                        </tr>
